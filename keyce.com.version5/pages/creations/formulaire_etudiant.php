...
<head>
    ...
    <link rel="icon" href="../../images/keyce.jpg">
...
<form method="POST" action="creer_etudiant.php" style="background-color: white;">
    ...
    <fieldset>
        ...
        <label>code niveau</label>
           ...
           <br><br>
<input type="text" placeholder="telephone etudiant" name="tel" require><br><br>
<input type="email" placeholder=" e-mail " name="mail" require><br><br>
<input type="text" placeholder="Numeros des parents" name="numpa" require><br>           <br>         
    </fieldset>
