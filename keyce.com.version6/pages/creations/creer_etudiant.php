...
try{
    ...
    $req="INSERT INTO `etudiant`( `nom`, `prenom`, `dtanaiss`, `lieu`, `nationalite`, `annee_inscription`, `code_niveau`, `nom_fil`, `telephone`, `email`, `tel_parent`, `mot_passe`)VALUES('$nom','$prenom','$dtnaiss','$lieu_naiss','$nationalite','$annee_inscription',
        '$code_niveau','$code_fil','$tel','$mail','$numpa','$mdp_user')";
