...
<div class="container">
    <div class="title" style="text-align:center;">Creation Niveau</div>
    <br>
    <div class="content">
    <form method="POST" action="creer_niveau.php">
        <div class="user-details">
          <div class="input-box">
            <span class="details" style="font-size: 24px;">intitulé du niveau</span>
            <input type="text" name="nomniveau" placeholder="nom niveau"><br><br>
            <span class="details" style="font-size: 24px;">code filiere</span>
