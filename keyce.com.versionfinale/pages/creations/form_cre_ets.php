...
<div class="container">
    <div class="title" style="text-align:center;">Creation Etablissement</div>
    <br>
    <div class="content">
    <form method="POST" action="creer_ets.php" autocomplete="off">
        <div class="user-details">
          <div class="input-box">
            <span class="details" style="font-size: 24px;">Nom de l'etablissement</span>
            <select class="nomets" name="nomets" required>
